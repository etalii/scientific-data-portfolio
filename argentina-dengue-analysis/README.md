...
| C.20 | 20_generate_epidemiological_portfolio_figures.R | Render four C.16--C.19 epidemiological portfolio figures while keeping season and calendar-year scopes distinct. |
...
Rscript scripts/visualization/20_generate_epidemiological_portfolio_figures.R
Rscript scripts/visualization/20_generate_epidemiological_portfolio_figures.R --language=en
~~~
...
manifest are versioned provenance metadata. The four C.10 PNGs and the four
C.20 analytical figure specifications, each with a Spanish and approved
English localized rendering, in figures/ are versioned deliverables and are
regenerated by their respective scripts.
...
figures/                Twelve versioned C.10 and C.20 portfolio figures
...
[portfolio visualization](docs/portfolio_descriptive_visualization_contract.md), and
[epidemiological portfolio visualization](docs/epidemiological_portfolio_visualization_contract.md).
...
current portfolio scope. Its English Quarto portfolio-report source is
[`reports/argentina_dengue_portfolio.qmd`](reports/argentina_dengue_portfolio.qmd);
its rendered [HTML portfolio report](reports/argentina_dengue_portfolio.html)
is a versioned deliverable when rendered with a local Quarto CLI. Future work
can add maps or broader comparisons only through new, explicitly documented
policies.
